...
CREATE UNIQUE INDEX ON "producer_order" (
    "customer_order_id",
    "producer_id"
);

CREATE UNIQUE INDEX ON "producer_settlement" (
    "settlement_week_id",
    "producer_id"
);
...
ALTER TABLE "product"
ADD FOREIGN KEY ("producer_id") REFERENCES "producer_profile" ("user_id");
...
ALTER TABLE "surplus_deal"
ADD FOREIGN KEY ("product_id") REFERENCES "product" ("id");

ALTER TABLE "cart"
ADD FOREIGN KEY ("customer_id") REFERENCES "customer_profile" ("user_id");
...
ALTER TABLE "order_item"
ADD FOREIGN KEY ("producer_order_id") REFERENCES "producer_order" ("id");
...
ALTER TABLE "order_commission"
ADD FOREIGN KEY ("commission_policy_id") REFERENCES "commission_policy" ("id");

ALTER TABLE "producer_settlement"
ADD FOREIGN KEY ("settlement_week_id") REFERENCES "settlement_week" ("id");

ALTER TABLE "producer_settlement"
ADD FOREIGN KEY ("producer_id") REFERENCES "producer_profile" ("user_id");

ALTER TABLE "producer_order_settlement_link"
ADD FOREIGN KEY ("producer_order_id") REFERENCES "producer_order" ("id");

ALTER TABLE "producer_order_settlement_link"
ADD FOREIGN KEY ("producer_settlement_id") REFERENCES "producer_settlement" ("id");
...
ALTER TABLE "recurring_order_template"
ADD FOREIGN KEY ("customer_id") REFERENCES "customer_profile" ("user_id");

ALTER TABLE "recurring_order_item"
ADD FOREIGN KEY ("template_id") REFERENCES "recurring_order_template" ("id");

ALTER TABLE "recurring_order_item"
ADD FOREIGN KEY ("product_id") REFERENCES "product" ("id");

ALTER TABLE "recurring_order_instance"
ADD FOREIGN KEY ("template_id") REFERENCES "recurring_order_template" ("id");
...
ALTER TABLE "content_product_link"
ADD FOREIGN KEY ("content_id") REFERENCES "content_post" ("id");
