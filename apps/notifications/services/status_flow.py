...
from apps.notifications.services.dispatch import notify_order_status_change
...
def transition_producer_order(
    ...
    # Notify customer of the status change (TC-010)
    notify_order_status_change(producer_order)
